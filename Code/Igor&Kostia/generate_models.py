...
#df_above15 = pd.read_csv('features/df_feature_above15_wo_google.csv', encoding="utf-8")
...
clf_list=[(RandomForestRegressor(**rfr_params1), selected_vars, "RF_params1_selected"),
          ...
          (BaggingRegressor(xgb.XGBRegressor(**xgb_params1), n_estimators=10, 
                       random_state=np.random.RandomState(2016)), all_vars, "xgboost1+bagging10_all"),
